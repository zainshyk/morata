...
$data = mysqli_fetch_array($query);
    ...
    if(isset($_POST['update'])){
        ...
        $update = "UPDATE `products` SET `Image1`='$filename1',`Image2`='$filename2',`Product`='$Product',`Price`='$Price',
`Description`='$Description',`Brand`='$Brand',`Category`='$Category',`Discount`='$Discount' WHERE id='$get'";
            ...
            <div class="row align-items-center">
              ...
              <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                ...
                <div class="custom-file mt-3 mb-3">
                  <input id="fileInput1" name="image1" type="file" value="<?php echo $data ['Image1'];?>" style="display:none;" />
                  <input id="fileInput2" name="image2" type="file" value="<?php echo $data ['Image2'];?>" style="display:none;" />
                  <input
                    type="button"
              ...
              <div class="col-12">
                <button type="submit" name="update" class="btn btn-primary btn-block text-uppercase">Update Product</button>
              </div>
            </form>
            </div>
